const finalCartOptions = {
  ...
  takeout: [
    ...
    { id: 'cardNang', label: '역삼 카드냥', price: 100 },
    { id: 'cardSquare', label: '신당 카드스퀘어', price: 100 },
    { id: 'minCityCardMarket', label: '대전 민씨지샵', price: 0 },
    { id: 'jejuDiMarket', label: '전주 디마켓', price: 100 },
    { id: 'maeulCardMarket', label: '역곡 마천루 카드장터', price: 100 },
    { id: 'areaZeroStore', label: '석계 에리어제로 스토어', price: 100 },
    { id: 'blackStone', label: '흑석 흑석 블랙스톤', price: 100 },
